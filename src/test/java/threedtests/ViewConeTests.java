...
import me.gorgeousone.netherview.threedstuff.DefinedLine;
...
public class ViewConeTests {
	...
	public void pointInCone() {
		...
		Rectangle nearPlane = new Rectangle(Axis.X, new Vector(100, 0, 0), 5, 10);
	...
	public void example() {
		...
		Rectangle nearPlane = new Rectangle(Axis.Z, new Vector(27, 66, 34), 2, 4);
		ViewCone cone = new ViewCone(viewPoint, nearPlane);
